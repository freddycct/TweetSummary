...
public class StreamSearch extends InferModel<Topic> 
{
	...
	public static void main(String [] args) throws Exception
	{
		...
		br = new BufferedReader(new FileReader(String.format("%s/data/tweets/%s_K=%d.decay_lda", model.prefix_dir, model.expt_name, model.K)));
		while((line=br.readLine())!=null)
		{
			String [] tokens = line.split("\t");
			Tweet tweet  = new Tweet();
